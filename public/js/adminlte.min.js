...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(["exports"], t)
      : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).adminlte = {}));
})(this, function (e) {
  "use strict";
  const t = [],
    n = (e) => {
  ...
  class g {
    ...
    addSidebarBreakPoint() {
      ...
      const s =
          null !==
            (t = null === (e = document.querySelector(u)) || void 0 === e ? void 0 : e.classList) &&
          void 0 !== t
            ? t
            : [],
  ...
  n(() => {
    var e;
    const t =
      null === document || void 0 === document ? void 0 : document.querySelector(".app-sidebar");
    if (t) {
      const e = new g(t, y);
      (e.init(),
        window.addEventListener("resize", () => {
    ...
    ((n.className = "sidebar-overlay"),
      null === (e = document.querySelector(".app-wrapper")) || void 0 === e || e.append(n),
      n.addEventListener(
        "touchstart",
        (e) => {
          e.preventDefault();
  ...
  const k = ".lte.card-widget",
    ...
    K = ".card-body",
    Q = ".card-footer",
    R = { animationSpeed: 500, collapseTrigger: G, removeTrigger: V, maximizeTrigger: I };
  class U {
    constructor(e, t) {
      ((this._element = e),
    ...
    toggle() {
      var e;
      (null === (e = this._parent) || void 0 === e ? void 0 : e.classList.contains(C))
        ? this.expand()
        : this.collapse();
    }
    maximize() {
        ...
        setTimeout(() => {
          ...
          (e && e.classList.add(N),
            this._parent &&
              ...
              this._parent.classList.contains(C) && this._parent.classList.add(W)));
        }, 150)),
        null === (e = this._element) || void 0 === e || e.dispatchEvent(t));
    }
    minimize() {
        ...
        setTimeout(() => {
          ...
          (t && t.classList.remove(N),
            this._parent &&
              ...
              (null === (e = this._parent) || void 0 === e ? void 0 : e.classList.contains(W)) &&
    ...
    toggleMaximize() {
      var e;
      (null === (e = this._parent) || void 0 === e ? void 0 : e.classList.contains(N))
        ? this.minimize()
        : this.maximize();
    }
  }
  ...
  class se {
    ...
    toggleFullScreen() {
      document.fullscreenEnabled &&
        (document.fullscreenElement ? this.outFullscreen() : this.inFullScreen());
    }
  }
  (n(() => {
