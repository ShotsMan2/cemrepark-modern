!(function (e) {
  ...
  var i = function () {
      ...
      var i = new Swiper(".product-thumbnail-slider", {
        ...
        spaceBetween: 20,
        direction: "vertical",
        breakpoints: { 0: { direction: "horizontal" }, 992: { direction: "vertical" } },
      });
    ...
    n = function () {
      if (typeof jarallax !== "undefined") {
        ...
        jarallax(document.querySelectorAll(".jarallax-keep-img"), { keepImg: !0 });
      }
    },
    o = function () {
        ...
        (e.each(n, function (e, n) {
          ...
          for (var o = 0, a = n.length; o < a; o++)
            ((i +=
              ...
              t++);
          ((i += "</span>"),
            (i += "<span class='letter' style='transition-delay:300ms;'>&nbsp;</span>"),
            t++);
        }),
          (this.innerHTML = i));
      });
  ...
  e(window).on("load", function () {
    ...
    e(".btn-nav").on("click tap", function () {
      e(".nav-content").toggleClass("showNav hideNav").removeClass("hidden");
  ...
  e(document).ready(function () {
    ...
    // AOS is now initialized via npm in AOSInitializer.js to prevent hydration mismatch
