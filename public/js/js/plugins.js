...
(function (t, e, i) {
  ...
  function w() {
    ...
    if (
      ...
      (_.mh = _.h),
      _.get("maxWidth") &&
        ((_.mw = a(_.get("maxWidth"), "x") - z - D), (_.mw = _.w && _.w < _.mw ? _.w : _.mw)),
      _.get("maxHeight") &&
          ...
          : s(_, e)
            ...
            : e &&
              M.load(e, _.get("data"), function (e, i) {
                d === le &&
                  h("error" === i ? n(se, "Error").html(_.get("xhrError")) : t(this).contents());
              });
  }
  var v,
    x,
    ...
    ce = (function () {
      ...
      return function () {
        r
          ...
          : _.get("slideshow") &&
            W[1] &&
            ((r = !0), ae.one(oe, o), _.get("slideshowAuto") ? i() : n(), S.show());
      };
    })();
  t[Y] ||
    (t(p),
          ...
          (y = !(
            ...
            !(
              ...
              ("object" == typeof p.stickTo &&
                p.stickTo instanceof ("undefined" != typeof HTMLDocument ? HTMLDocument : Document))
            )
          )),
        ...
        ((B = e < F ? "up" : "down"),
          ...
          j < (F = e)
            ? O + L + (C ? k : 0) - (p.followScroll && C ? 0 : L) <=
              e + z - x - (E - (j - x) < z - x && p.followScroll && 0 < (t = z - E - x) ? t : 0)
              ? I.release({ position: "absolute", bottom: w + s.offsetHeight - O - L })
              : C && p.followScroll
                ? "down" == B
                  ? i + z + k <= E + 0.9
                    ? I.stick({ bottom: k })
      ...
      function a() {
        null !== n.offsetParent && "none" !== u.getStyle(n, "display")
          ? (i(),
            v < z
              ? l()
              : (r(), M || (V.addEventListener("scroll", r, u.supportsPassive), (M = !0))))
          : l();
      }
      function c() {
        ((n.style.position = ""),
          ...
          n.classList
            ...
            : (n.className = n.className.replace(
                new RegExp("(^|\\b)" + p.stickyClass.split(" ").join("|") + "(\\b|$)", "gi"),
                " "
              )),
          (I.css = {}),
            ...
            (((t = t || {}).stop = t.stop || !1),
              (!0 !== t.stop &&
                ...
                ((void 0 === t.top && void 0 === t.bottom) ||
                  (void 0 !== t.top && (parseInt(u.getStyle(n, "top")) || 0) === t.top) ||
                  (void 0 !== t.bottom &&
    ...
    t.Helpers = {
      ...
      getCascadedStyle: function (t) {
        ...
        ((o.style.display = "none"),
          ...
          o.currentStyle
            ? (e = o.currentStyle)
            : a.getComputedStyle && (e = c.defaultView.getComputedStyle(o, null)));
        var i,
          n,
          s,
          r = {};
