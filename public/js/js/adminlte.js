...
(function (global, factory) {
  ...
  class PushMenu {
    ...
    addSidebarBreakPoint() {
      ...
      const sidebarExpandList =
        (_b =
          (_a = document.querySelector(SELECTOR_SIDEBAR_EXPAND)) === null || _a === void 0
            ? void 0
  ...
  onDOMContentLoaded(() => {
    ...
    (_a = document.querySelector(SELECTOR_APP_WRAPPER)) === null || _a === void 0
      ? void 0
    ...
    fullBtn.forEach((btn) => {
      btn.addEventListener("click", (event) => {
        ...
        if (
          (button === null || button === void 0 ? void 0 : button.dataset.lteToggle) !== "sidebar"
        ) {
          button =
            button === null || button === void 0 ? void 0 : button.closest(SELECTOR_SIDEBAR_TOGGLE);
        }
        if (button) {
      ...
      if (this._parent) {
        ...
        const elm =
          (_a = this._parent) === null || _a === void 0
            ? void 0
            : _a.querySelectorAll(`${SELECTOR_CARD_BODY}, ${SELECTOR_CARD_FOOTER}`);
        elm.forEach((el) => {
