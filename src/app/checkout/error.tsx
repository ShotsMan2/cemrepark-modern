  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full glass-card p-8 text-center space-y-6">
        ...
        <h2 className="text-2xl font-bold text-foreground">Ödeme İşlemi Sırasında Hata</h2>
        <p className="text-foreground/60 text-sm">
          {error.message || "Ödeme adımlarını yüklerken bir sorun oluştu. Lütfen tekrar deneyin veya sepetinize dönün."}
        </p>
