        ...
        <div className="w-full max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {bestSellers.map((product, index) => (
              <div
                key={product.id}
                className="glass-panel p-4 clip-angled group hover:border-neon-pink transition-colors relative"
                data-aos="fade-up"
        ...
        <div className="w-full max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="glass-panel p-8 clip-angled relative"
                data-aos="fade-up"
        ...
        <div className="w-full max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={i}
                className="glass-panel p-8 text-center group clip-hexa hover:border-holo-gold transition-colors duration-300"
                data-aos="zoom-in"
