      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="p-8 border border-white/10 bg-black/40 clip-angled my-10 relative overflow-hidden">
            ...
            <h3 className="text-white font-bold text-xl uppercase tracking-widest mb-4">{t("our_vision_title")}</h3>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">{t("email_title")}</h4>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">{t("phone_title")}</h4>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">{t("address_title")}</h4>
