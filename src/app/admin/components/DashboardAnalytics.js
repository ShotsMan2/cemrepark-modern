...
const PIE_COLORS = ["#047857", "#d97706", "#059669", "#f59e0b", "#10b981", "#fbbf24"];
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data.salesOverTime || []} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="total" name="Gelir" stroke="#047857" strokeWidth={3} fillOpacity={1} fill="url(#colorTotal)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
