      ...
      <div className="lg:col-span-1">
        <div className="glass-panel p-6 clip-angled sticky top-28">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-gray-400 text-xs font-bold mb-1 uppercase tracking-wider">Etiket (Yeni Sezon, vb.)</label>
            ...
            <div>
              <label className="block text-gray-400 text-xs font-bold mb-1 uppercase tracking-wider">Kategori (Elbise, vb.)</label>
            ...
            <div>
              <label className="block text-gray-400 text-xs font-bold mb-1 uppercase tracking-wider">Renk Seçenekleri</label>
              <input type="text" name="renk" value={formData.renk} onChange={handleInputChange} className="w-full bg-black/50 border border-white/10 text-white px-3 py-2 text-sm focus:border-neon-pink outline-none" placeholder="Örn: Siyah, Kırmızı" />
            </div>

            <div>
              <label className="block text-gray-400 text-xs font-bold mb-1 uppercase tracking-wider">Beden Seçenekleri</label>
              <input type="text" name="beden" value={formData.beden} onChange={handleInputChange} className="w-full bg-black/50 border border-white/10 text-white px-3 py-2 text-sm focus:border-neon-pink outline-none" placeholder="Örn: S, M, L, XL" />
            </div>
