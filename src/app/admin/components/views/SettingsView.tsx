...
export default function SettingsView() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      const payload = {
        ...formData,
        kargoUcreti: Number(formData.kargoUcreti) || 0,
        ucretsizKargoLimiti: Number(formData.ucretsizKargoLimiti) || 0,
      };
    ...
    <div className="animate-fade-in max-w-6xl mx-auto space-y-6 text-left">
      <div className="glass-panel p-6 clip-angled flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-foreground/50 text-sm mt-1">
            Sitenizin genel bilgilerini ve işleyiş kurallarını yapılandırın. (Son Güncelleme:{" "}
            {lastModified})
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="bg-foreground/10 text-foreground px-4 py-2 text-xs font-bold uppercase tracking-wider hover:bg-neon-pink transition-colors"
          >
            Cache Temizle
          </button>
          <button
            onClick={handleExport}
            className="bg-foreground/10 text-foreground px-4 py-2 text-xs font-bold uppercase tracking-wider hover:bg-holo-gold transition-colors"
          >
            Dışa Aktar
          </button>
      ...
      <div className="glass-panel p-8 clip-angled min-h-[500px]">
        <form onSubmit={handleSave} className="space-y-6 h-full flex flex-col justify-between">
          {/* Genel Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "Genel" ? "block" : "hidden"}`}
          >
            <div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={3}
                className="w-full bg-background/50 border border-glass-border text-foreground px-4 py-3 text-sm focus:border-neon-pink outline-none transition-colors resize-none"
              />
            </div>
          </div>
          ...
          {/* Kargo Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "Kargo & Teslimat" ? "block" : "hidden"}`}
          >
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                Kargo Ücreti (TL)
            ...
            <div className="md:col-span-2">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-foreground/70 text-sm font-bold uppercase tracking-wider">
                  Aynı Gün Teslimat Seçeneğini Aktif Et
                </span>
              </label>
            </div>
          </div>
          ...
          {/* Ödeme Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "Ödeme" ? "block" : "hidden"}`}
          >
            <div className="md:col-span-2">
              <h3 className="text-holo-gold font-bold uppercase mb-4">Havale/EFT Bilgileri</h3>
            </div>
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                Banka Adı
            ...
            <div className="md:col-span-2 mt-4">
              <h3 className="text-neon-pink font-bold uppercase mb-4">Shopier Entegrasyonu</h3>
            </div>
            <div className="md:col-span-2">
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                Shopier URL / API Key
          ...
          {/* E-posta Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "E-posta" ? "block" : "hidden"}`}
          >
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                SMTP Host
          ...
          {/* Sosyal Medya Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "Sosyal Medya" ? "block" : "hidden"}`}
          >
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                Instagram URL
          ...
          {/* SEO Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "SEO" ? "block" : "hidden"}`}
          >
            <div className="md:col-span-2">
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={3}
                className="w-full bg-background/50 border border-glass-border text-foreground px-4 py-3 text-sm focus:border-neon-pink outline-none resize-none"
              />
            </div>
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
          ...
          {/* Döviz Kurları Tab */}
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in ${activeTab === "Döviz Kurları" ? "block" : "hidden"}`}
          >
            <div>
              <label className="block text-foreground/50 text-xs font-bold mb-2 uppercase tracking-wider">
                USD/TRY Oranı
            ...
            <div className="md:col-span-2">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-foreground/70 text-sm font-bold uppercase tracking-wider">
                  Otomatik Güncelleme Aktif (TCMB)
                </span>
              </label>
            </div>
          </div>
          ...
          {/* Gelişmiş Tab */}
          <div
            className={`space-y-6 animate-fade-in ${activeTab === "Gelişmiş" ? "block" : "hidden"}`}
          >
            <div className="p-4 border border-red-500/30 bg-red-500/5 clip-angled">
              ...
              <p className="text-foreground/50 text-sm mb-4">
                Siteyi ziyaretçilere kapatın. Sadece adminler görebilir.
              </p>
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                <span className="ml-3 text-sm font-bold text-foreground/70 uppercase">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={6}
                className="w-full bg-background/50 border border-glass-border text-foreground px-4 py-3 text-sm focus:border-neon-pink outline-none transition-colors font-mono text-xs"
          ...
          <div className="pt-6 border-t border-glass-border">
            <button
              type="submit"
              className="bg-neon-pink text-foreground font-bold py-3 px-8 uppercase tracking-widest text-sm hover:bg-white hover:text-black transition-colors clip-angled"
            >
