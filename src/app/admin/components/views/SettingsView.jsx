    ...
    <div className="animate-fade-in max-w-4xl">
      <div className="glass-panel p-6 clip-angled mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Sitenizin genel bilgilerini ve işleyiş kurallarını yapılandırın.
        </p>
      </div>
      ...
      <div className="glass-panel p-8 clip-angled min-h-[400px]">
        <form onSubmit={handleSave} className="space-y-6 h-full flex flex-col justify-between">
              ...
              <div className="md:col-span-2">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-gray-300 text-sm font-bold uppercase tracking-wider">
                    Aynı Gün Teslimat Seçeneğini Aktif Et (Sadece İstanbul)
                  </span>
                </label>
              </div>
            </div>
          ...
          <div className="pt-6 border-t border-white/10">
            <button
              type="submit"
              className="bg-neon-pink text-white font-bold py-3 px-8 uppercase tracking-widest text-sm hover:bg-white hover:text-black transition-colors clip-angled"
            >
