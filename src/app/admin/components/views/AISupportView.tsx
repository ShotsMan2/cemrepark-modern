    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel p-6 clip-angled relative overflow-hidden group hover:border-neon-pink transition-colors">
          ...
          <p className="text-foreground/50 text-xs font-bold uppercase tracking-widest mb-1">Toplam AI Görüşmesi</p>
        ...
        <div className="glass-panel p-6 clip-angled relative overflow-hidden group hover:border-holo-gold transition-colors">
          ...
          <p className="text-foreground/50 text-xs font-bold uppercase tracking-widest mb-1">Otomatik Çözüm Oranı</p>
        ...
        <div className="glass-panel p-6 clip-angled relative overflow-hidden group hover:border-green-500 transition-colors">
          ...
          <p className="text-foreground/50 text-xs font-bold uppercase tracking-widest mb-1">Ort. Memnuniyet</p>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {conversations.map((conv) => (
              <div key={conv.id} className="bg-black/40 border border-glass-border p-5 clip-angled hover:border-white/20 transition-all group">
                <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-3">
                  <div>
                    ...
                    <p className="text-foreground/50 text-xs">Müşteri: <span className="text-gray-200">{conv.customer}</span> • {conv.date} • {conv.messagesCount} mesaj</p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-foreground/50 font-bold">% {conv.satisfaction}</span>
                  </div>
                </div>
