...
export default function Loading() {
  return (
    <div className="min-h-screen pt-32 pb-24 relative container mx-auto px-4 z-10 bg-gradient-to-br from-gray-50 via-primary/50 to-purple/50 dark:from-[#08060d] dark:via-[#0d0518] dark:to-[#0a0814]">
