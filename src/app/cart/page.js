      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-20" data-aos="fade-up">
            ...
            <Link
              href="/search"
              className="bg-white text-black px-8 py-3 uppercase tracking-widest text-sm font-bold clip-angled hover:bg-neon-pink hover:text-white transition-colors"
            >
                    ...
                    >
                      ...
                      <div className="col-span-1 md:col-span-6 flex gap-4 items-center">
                        ...
                        <div>
                          <Link
                            href={`/urundetay/${item.id}`}
                            className="text-lg font-bold text-white hover:text-neon-pink transition-colors mb-1 block"
                          >
                            {t(item.ad)}
                          </Link>
                          <div className="flex items-center gap-3 text-xs text-gray-400">
                            <span className="bg-white/5 px-2 py-1 rounded">
                              {t("size")}: <strong className="text-white">{item.beden}</strong>
                            </span>
                            <span className="bg-white/5 px-2 py-1 rounded">
                              {t("color")}: <strong className="text-white">{item.renk}</strong>
                            </span>
                          </div>
                        </div>
                      </div>
