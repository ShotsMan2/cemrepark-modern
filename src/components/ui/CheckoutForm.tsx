          ...
          {paymentMethod === "credit_card" ? (
            ...
            <div className="bg-secondary/10 border border-secondary/30 rounded-xl p-6 text-center animate-slide-up">
              ...
              <p className="text-foreground/70 text-sm">
                Siparişinizi tamamladıktan sonra, ekranda görünecek olan IBAN numaralarımızdan
                birine sipariş tutarını gönderebilirsiniz.
                <br className="hidden md:block" /> Açıklama kısmına sipariş numaranızı yazmayı
                unutmayın!
              </p>
            </div>
          )}
