...
export default function NewsletterForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-neon-pink text-white font-bold uppercase tracking-widest px-8 py-4 clip-angled hover:bg-holo-gold hover:text-black transition-colors duration-300"
      >
        {t("subscribe")}
      </button>
    </form>
