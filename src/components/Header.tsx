        ...
        <div className="w-full px-4 md:px-6 flex justify-between items-center relative">
                ...
                <div className="container mx-auto px-4 py-12">
                  <div className="grid grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 relative h-48 clip-angled group/img overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-primary/50 to-secondary/50 mix-blend-overlay z-10"></div>
                      <Image
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="text-gray-600 dark:text-gray-300 hover:text-secondary transition-all duration-300 hover:scale-110"
            ...
            <Link
              href="/favorites"
              className="relative text-gray-600 dark:text-gray-300 hover:text-primary transition-all duration-300 hover:scale-110 inline-block"
            ...
            >
              ...
              {isLoaded && favoriteItems.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-secondary text-black text-[10px] font-bold px-1.5 py-0.5 rounded-full">
            ...
            <Link
              href="/cart"
              className="relative text-gray-600 dark:text-gray-300 hover:text-secondary transition-all duration-300 hover:scale-110 inline-block"
              aria-label="Cart"
            >
              <svg
                width="20"
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="absolute -top-12 right-4 text-gray-500 hover:text-primary transition-colors"
          ...
          <form role="search" method="get" className="relative group" action="/search">
            ...
            <div className="absolute -bottom-0.5 left-0 w-full h-[2px] bg-gradient-to-r from-primary to-secondary scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
            ...
            <button
              type="submit"
              className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-600 hover:text-secondary transition-colors"
